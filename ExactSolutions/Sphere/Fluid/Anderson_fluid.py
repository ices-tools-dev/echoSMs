...
for f in freq_Hz:
    ...
    for m in range(order_max):
        sphjkas = (m/ka_sphere)*spherical_jn(m, ka_sphere)-spherical_jn(m+1,
                ka_sphere)
        sphjkaw = (m/ka_water)*spherical_jn(m, ka_water)-spherical_jn(m+1,
                ka_water)
        sphykas = (m/ka_sphere)*spherical_yn(m, ka_sphere)-spherical_yn(m+1,
                ka_sphere)
        sphykaw = (m/ka_water)*spherical_yn(m, ka_water)-spherical_yn(m+1,
                ka_water)
