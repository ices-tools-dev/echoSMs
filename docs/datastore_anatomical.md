...
The format of the dataset files is specified by the echoSMs [schema](datastore_schema.md).
...
|---------------|-----------|--------------------|-----|--|
|surface|3D triangular surface mesh|BEM, KA|[data]({{ds_uri("v2/specimen/770f19a1-9b9f-4a91-930c-92eaa235b956/data")}}), [image]({{ds_uri("v2/specimen/770f19a1-9b9f-4a91-930c-92eaa235b956/image")}})|ρ and c per shape|
|outline|Dorsal and ventral outlines along a curved centreline|KRM, DWBA, DCM|[data]({{ds_uri("v2/specimen/48d60557-f9d5-4bb3-a977-00d8db818a56/data")}}), [image]({{ds_uri("v2/specimen/48d60557-f9d5-4bb3-a977-00d8db818a56/image")}})|ρ and c per shape (KRM) or per section (DWBA)|
|voxels|3D rectangular grid|FEM|[data]({{ds_uri("v2/specimen/658185f5-6e81-4c18-a572-28051c1f6e1d/data")}}), [image]({{ds_uri("v2/specimen/658185f5-6e81-4c18-a572-28051c1f6e1d/image")}})|ρ and c for each voxel|
|categorised voxels|categorised 3D rectangular grid|PT-DWBA|[data]({{ds_uri("v2/specimen/0e78608f-82e0-4ed5-af68-328cf42c9362/data")}}), [image]({{ds_uri("v2/specimen/0e78608f-82e0-4ed5-af68-328cf42c9362/image")}})|ρ and c for each category|
|geometric|combination of simple shapes|MFS|[data]({{ds_uri("v2/specimen/91984396-2daf-433c-a2ac-55393b9a91b3/data")}}), [image]({{ds_uri("v2/specimen/91984396-2daf-433c-a2ac-55393b9a91b3/image")}})|ρ and c per shape|
