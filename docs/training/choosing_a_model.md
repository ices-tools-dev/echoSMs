...
There are three major categories of scattering models that are relevant to fisheries acoustics. These are:

### Analytic/semi-analythic models

- _Application:_ simple geometric shapes (e.g. spheres, cylinders, prolate spheroids)
- _Advantages:_ exact, fast, not restricted in frequency/material properties
- _Disadvantages:_ not possible to resolve for complex, realistic targets, assumes a single scattering object
...
- _Advantages_
    ...
    - Fast (very) and relatively simple
- _Disadvantages_
...
The choice of a model depends on the type of object you want to estimate the scattering from, the material properties, the acoustic frequencies, and how long you are prepared to wait for a model to run.
...
- Other relevant references are:
    ...
    - _Gorska, N., & Ona, E. (2003). Modelling the acoustic effect of swimbladder compression in herring. ICES Journal of Marine Science, 60(3), 548-554._  
    - _Horne, J. K., Walline, P. D., & Jech, J. M. (2000). Comparing acoustic model predictions to in situ backscatter measurements of fish with dual‐chambered swimbladders. Journal of fish Biology, 57(5), 1105-1121._  
