...
|shape_type|yes|Type of shape data used for this specimen.|enum of string|one of ``outline``, ``surface``, ``voxels``, ``categorised voxels``, ``geometric``|
...
|straightened|no|Was the shape straightened during the processing.|boolean||
|smoothed|no|Was the shape smoothed during the processing.|boolean||
|rotated|no|Was the shape rotated during the processing.|boolean||
|notes|no|Explanatory notes about the straightening, smoothing, and rotation of the shape.|array of string|<br>|
...
=== "``geometric``"
    ...
    |Property|Required|Description|Type|Constraints|
    |---|---|---|---|---|
    |geometric_form|yes|Geometric form of this shape|enum of string|one of ``cylinder``, ``sphere``|

and includes these properties as per the value of ``geometric_form``
...
=== "``cylinder``"
    ...
    |Property|Required|Description|Type|Constraints|
    |---|---|---|---|---|
    |radius|yes|Radius of the cylinder.|number|minimum: 0|
    |length|yes|Length of the cylinder.|number|minimum: 0|
    |shape_units|yes|The units of the radius and length.|enum of string|must be: ``m``|
...
=== "``sphere``"
    ...
    |Property|Required|Description|Type|Constraints|
    |---|---|---|---|---|
    |radius|yes|Radius of the sphere.|number|minimum: 0|
    |shape_units|yes|The units of the radius.|enum of string|must be: ``m``|
