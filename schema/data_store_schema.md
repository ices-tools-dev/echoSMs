...
|anatomical_type|yes|Type of anatomical feature represented by this shape.|enum of string|one of ``body``, ``swimbladder``, ``backbone``, ``muscle``, ``head``, ``eye``, ``organs``, ``appendages``, ``other``|
